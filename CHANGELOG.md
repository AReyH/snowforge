...
- `SnowcraftConnection`: Context-managed Snowflake connection wrapper with env var fallback.
...
- Custom exception hierarchy: `SnowcraftError`, `ConnectionError`, `SchemaError`, `MergeError`, `ProfilerError`.
